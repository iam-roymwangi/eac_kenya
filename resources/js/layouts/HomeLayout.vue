            ...
            >
                ...
                <div class="hidden items-center gap-8 lg:flex">
                    ...
                    <button
                        ...
                        class="rounded-full bg-emerald-600 px-6 py-2.5 text-[10px] font-black tracking-widest text-white uppercase transition-all hover:shadow-xl hover:shadow-emerald-200"
                    >
                        Contact Us
                    </button>
                </div>
